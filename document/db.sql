...
CREATE TABLE t_platform (
    id INT UNSIGNED AUTO_INCREMENT PRIMARY KEY COMMENT '数据库主键',
...
CREATE TABLE t_category (
    ...
    parent_id INT UNSIGNED COMMENT '父类别的标识符',
...
CREATE TABLE t_product (
    ...
    category_id INT UNSIGNED COMMENT '产品所属的类别标识符',
...
CREATE TABLE t_image (
    id INT UNSIGNED AUTO_INCREMENT PRIMARY KEY COMMENT '数据库主键',
    domain ENUM('Product', 'Goods') COMMENT '类型场景',
    domain_id INT UNSIGNED COMMENT '关联产品的标识符',
...
CREATE TABLE t_order (
    ...
    status_id INT UNSIGNED COMMENT '订单当前状态ID',
...
CREATE TABLE t_wms_inventory (
    ...
    warehouse_id INT UNSIGNED COMMENT '关联仓库的标识符',
...
CREATE TABLE t_wms_goods (
    ...
    category_id INT UNSIGNED COMMENT '商品分类',
