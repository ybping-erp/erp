...
func Routers() *gin.Engine {
	...
	{
		wmsRouter := router.RouterGroupApp.Wms
		wmsRouter.InitGoodsRouter(PrivateGroup)
		wmsRouter.InitInventoryRouter(PrivateGroup)
		wmsRouter.InitLogisticsPackagingRouter(PrivateGroup)
	...
	}
	{
		...
		sharedRouter.InitRuleRouter(PrivateGroup)
	}
